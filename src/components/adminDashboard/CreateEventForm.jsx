    ...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full p-2 border border-gray-300 rounded-md"
                    placeholder="e.g., Free for all participants"
                    rows="2"
                  ></textarea>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 border border-gray-300 rounded-md"
                    placeholder="e.g., techcorp_logo.png"
                  />
                  <p className="text-xs text-gray-500 mt-1">Sponsor logo filename or URL</p>
                </div>
              </div>
            </div>
          ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 border border-gray-300 rounded-md"
                    placeholder="e.g., rajesh_profile.jpg"
                  />
                  <p className="text-xs text-gray-500 mt-1">Profile image filename or URL</p>
                </div>
              </div>
            </div>
          ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 border border-gray-300 rounded-md"
                    placeholder="e.g., https://example.com/rules"
                  />
        ...
        <div className="flex justify-center">
          ...
          >
            <Save className="w-5 h-5 mr-2" /> Create Event
          </button>
        </div>
      </form>
    </div>
